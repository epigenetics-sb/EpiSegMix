include { EPISEGMIX_DNA_PREPARE } from '../../../modules/local/episegmix_dna_prepare/main.nf'
include { EPISEGMIX_DNA_TRAIN   } from '../../../modules/local/episegmix_dna_train/main.nf'
include { EPISEGMIX_DNA_DECODE  } from '../../../modules/local/episegmix_dna_decode/main.nf'
include { EPISEGMIX_DNA_REPORT  } from '../../../modules/local/episegmix_dna_report/main.nf'
